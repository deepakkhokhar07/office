				...
				fs.write(Files[Name]['Handler'], Files[Name]['Data'], null, 'Binary', function(err, Writen){
					...
					util.pump(inp, out, function(){
						fs.unlink(__dirname+"/Temp/" + Name, function () { //This Deletes The Temporary File
							exec("ffmpeg -i "+__dirname+"/Video/" + Name  + " -ss 01:30 -r 1 -an -vframes 1 -f mjpeg "+__dirname+"/Video/" + Name  + ".jpg", function(err){
								socket.emit('Done', {'Image' : __dirname+'/Video/' + Name + '.jpg'});
							});
						});
					});
				});
